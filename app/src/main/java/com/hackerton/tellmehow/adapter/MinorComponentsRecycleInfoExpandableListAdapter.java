...
public class MinorComponentsRecycleInfoExpandableListAdapter extends BaseExpandableListAdapter {

    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, List<String>> expandableListDetail;

    public MinorComponentsRecycleInfoExpandableListAdapter(Context context, List<String> expandableListTitle,
    ...
    public void updateAdapter(List<String> expandableListTitle,
                              HashMap<String, List<String>> expandableListDetail) {
